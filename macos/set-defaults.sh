...
defaults write com.apple.print.PrintingPrefs "Quit When Finished" -bool truea
...
# in the login window
sudo defaults write /Library/Preferences/com.apple.loginwindow AdminHostInfo HostNamea
